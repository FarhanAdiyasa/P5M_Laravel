      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="list-group">
            ...
            <a type="button" class="list-group-item list-group-item-action" href="sop" >Masuk Sebagai KOORDINATOR SOP dan TATIB</a>
            <a type="button" class="list-group-item list-group-item-action" href="tingkat" >Masuk Sebagai KOORDINATOR TINGKAT</a>
