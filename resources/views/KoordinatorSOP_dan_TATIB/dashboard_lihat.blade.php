        ...
        <section class="section dashboard">
            <div class="row">
                        ...
                        <div id="chart">
                            ...
                            <script>
                                (function () {
                                    ...
                                    const data = {
                                        labels: @json(collect($result)->pluck('nama_pelanggaran')),
                                        datasets: [{
                                            label: 'Total Pelanggaran Dilakukan',
                                            data: @json(collect($result)->pluck('total_pelanggaran_dilakukan')),
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="filter">
                        <i class="bi bi-download bi-4x mx-3" style="cursor:pointer" id="downloadButton" onclick="downloadAktifitas()"></i>                        </div>
                        <div class="card-body">
                            ...
                            <li><a class="dropdown-item" href="#">This Year</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="nimChart">
                                        ...
                                        <script>
                                            (function () {
                                                const ctx = document.getElementById('nimChartCanvas');

                                                const data = {
                                                    labels: @json(collect($result)->pluck('nama_pelanggaran')),
                                                    datasets: [{
                                                        label: 'Total Jam Minus',
                                                        data: @json(collect($result)->pluck('total_pelanggaran_dilakukan')),
                                                        backgroundColor: @json($backgroundColors),
                                                    }]
                                                };
